...
{   /* test basic properties of f1oat.h macros */
    ...
    printf("DBL_MAX_10_EXP = %5i DBL_MAX_EXP = %6i\n",
        DBL_10_EXP, DBL_MAX_EXP);
    printf("DBL_MIN_1O_EXP = %5i DBL_MIN_EXP = %6i\n",
    ...
    printf("FLT_MAX_10_EXP = %5i FLT_EXP = %6i\n",
        FLT_10_EXP, FLT_MAX_EXP);
    ...
    printf("LDBL_MAX_1O_EXP = %5i LDBL_MAX_EXP = %6i\n",
        LDBL_10_EXP, LDBL_MAX_EXP);
...
#if FLT_RADIX == 2
    assert(ldexp(1.0, DBL_EXP - 1) < DBL_MAX);
...
#error bad FLT_RADIX
    ...
    aeeert(LDBL_MIN_EXP < DBL_MIN_EXP
