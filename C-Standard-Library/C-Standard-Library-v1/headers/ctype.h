...
#define _UP     0x02    /* 'A' -'Z' */
#define _XD     0x01    /* 'Or-'9', 'A'-'Fr, 'ar-'fr */
/* declarations */
...
extern const short *_Ctype, *_Tolower, *_Toupper; /* macro overrides */
...
#define ispunct(c) (_Ctype[(int) (c)] & -_U)
#define isspace(c) (_Ctype[(int) (c)] & (_CN|-SP|_XS))
