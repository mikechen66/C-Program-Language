 ...
 * main.c:40:13: warning: implicit declaration of function ‘myqsort’; did you mean ‘mqsort’? [-Wimplicit-function-declaration]
 *             myqsort((void **)lineptr,0,nlines-1,(int (*)(void *,void *))numcmp);
 *             ^~~~~~~
 *             mqsort
 * main.c: In function ‘numcmp’:
 * main.c:114:10: warning: implicit declaration of function ‘atof’; did you mean ‘atanf’? [-Wimplicit-function-declaration]
 *     v1 = atof(str);
 *          ^~~~
 *          atanf
 * main.c: At top level:
 * main.c:180:6: error: conflicting types for ‘substr’
 * void substr(char *s,char *str)
 *      ^~~~~~
 * main.c:104:6: note: previous declaration of ‘substr’ was here
 * void substr(char *s,char *t,int maxstr);
 *      ^~~~~~
 * main.c: In function ‘error’:
 * main.c:201:5: warning: implicit declaration of function ‘exit’ [-Wimplicit-function-declaration]
 *     exit(1);
 *     ^~~~
 * main.c:201:5: warning: incompatible implicit declaration of built-in function ‘exit’
 * main.c:201:5: note: include ‘<stdlib.h>’ or provide a declaration of ‘exit’
 * main.c: At top level:
 * main.c:216:6: warning: conflicting types for ‘myqsort’
 * void myqsort(void *v[],int left,int right,int (*comp)(void *,void *))
 *      ^~~~~~~
 * main.c:40:13: note: previous implicit declaration of ‘myqsort’ was here
 *             myqsort((void **)lineptr,0,nlines-1,(int (*)(void *,void *))numcmp);
 *             ^~~~~~~
 * main.c:261:6: error: conflicting types for ‘writelines’
 * void writelines(char *lineptr[],int nlines)
 *      ^~~~~~~~~~
 * main.c:19:6: note: previous declaration of ‘writelines’ was here
 * void writelines(char *lineptr[],int nlines,int order);
 *      ^~~~~~~~~~
 * main.c: In function ‘mgetline’:
 * main.c:299:43: error: expected ‘;’ before ‘c’
 *     for(i=0;i<lim-1 && (c=getchar())!=EOF c!='\n';++i)
 *                                           ^
 */