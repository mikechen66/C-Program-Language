 ...
 * main.c:64:49: error: ‘res’ undeclared (first use in this function)
 *     for(n=0;n<SIZE && getint(&array[n]) !=EOF; (res!=0) ? n++:0 ){
 *                                                 ^~~
 * main.c:64:49: note: each undeclared identifier is reported only once for each function it appears in
 */
