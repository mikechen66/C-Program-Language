 ...
 *
 * $gcc -o main *.c
 * main.c: In function ‘filecopy’:
 * main.c:40:17: warning: implicit declaration of function ‘read’; did you mean ‘fread’? [-Wimplicit-function-declaration]
 *     while ((n = read(ifd, buf, BUFSIZ)) > 0)
 *                 ^~~~
 *                 fread
 * main.c:41:13: warning: implicit declaration of function ‘write’; did you mean ‘fwrite’? [-Wimplicit-function-declaration]
 *         if (write(ofd, buf, n) != n)
 *             ^~~~~
 *             fwrite
 * main.c: In function ‘main’:
 * main.c:68:17: warning: implicit declaration of function ‘close’; did you mean ‘pclose’? [-Wimplicit-function-declaration]
 *                 close(fd);
 *                 ^~~~~
 *                 pclose
 * $main
