 ...
 * 
 * $gcc -o main *.c
 * main.c:9:0: warning: "NAME_MAX" redefined
 * #define NAME_MAX 14
 *
 ...
 *                 from main.c:7:
 * /usr/include/linux/limits.h:11:0: note: this is the location of the previous definition
// #define NAME_MAX         255 /* # chars in a file name */
/*  
 * main.c: In function ‘fsize’:
 * main.c:76:116: error: ‘struct stat’ has no member named ‘st_flags’; did you mean ‘st_nlink’?
 *     printf("%8ld - %8ld - %8ld - %8ld - %8ld - %8ld %s\n", stbuf.st_size, stbuf.st_blocks, stbuf.st_blksize, stbuf.st_flags, stbuf.st_gen, stbuf.st_nlink, name);
 *                                                                                                                    ^~~~~~~~
 *                                                                                                                    st_nlink
 * main.c:76:132: error: ‘struct stat’ has no member named ‘st_gen’; did you mean ‘st_dev’?
 *     printf("%8ld - %8ld - %8ld - %8ld - %8ld - %8ld %s\n", stbuf.st_size, stbuf.st_blocks, stbuf.st_blksize, stbuf.st_flags, stbuf.st_gen, stbuf.st_nlink, name);
 *                                                                                                                                   ^~~~~~
 *                                                                                                                                   st_dev
 * main.c: In function ‘myclosedir’:
 * main.c:131:9: warning: implicit declaration of function ‘close’; did you mean ‘pclose’? [-Wimplicit-function-declaration]
 *         close(dp->fd);
 *         ^~~~~
 *         pclose
 * main.c: In function ‘myreaddir’:
 * main.c:146:12: warning: implicit declaration of function ‘read’; did you mean ‘fread’? [-Wimplicit-function-declaration]
 *     while (read(dp->fd, (char *) &dirbuf, sizeof(dirbuf)) == sizeof(dirbuf)) {
 *            ^~~~
 *            fread
 */