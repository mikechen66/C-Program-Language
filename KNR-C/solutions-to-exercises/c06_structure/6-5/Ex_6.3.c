 ...
 *
 * $gcc -o main *.c
 * main.c: In function ‘addlinenumber’:
 * main.c:250:19: warning: assignment makes pointer from integer without a cast [-Wint-conversion]
 *         p->number = linenumber;
 *                   ^
 * main.c: In function ‘treeprint’:
 * main.c:270:9: warning: implicit declaration of function ‘printnumbers’; did you mean ‘addlinenumber’? [-Wimplicit-function-declaration]
 *         printnumbers(p->linenumbers);
 *         ^~~~~~~~~~~~
 *         addlinenumber
 * main.c: At top level:
 * main.c:275:6: warning: conflicting types for ‘printnumbers’
 * void printnumbers(const struct linenumber *p) {
 *      ^~~~~~~~~~~~
 * main.c:270:9: note: previous implicit declaration of ‘printnumbers’ was here
 *         printnumbers(p->linenumbers);
 *         ^~~~~~~~~~~~
 * $main
 */