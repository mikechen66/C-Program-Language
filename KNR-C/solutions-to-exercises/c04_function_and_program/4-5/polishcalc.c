 ...
 *
 * $gcc -o main *.c
 * /tmp/ccdGT8Hx.o: In function `dofunc':
 * main.c:(.text+0x16e): undefined reference to `sin'
 * main.c:(.text+0x197): undefined reference to `cos'
 * main.c:(.text+0x1c0): undefined reference to `cos'
 * main.c:(.text+0x1e9): undefined reference to `exp'
 * main.c:(.text+0x28b): undefined reference to `pow'
