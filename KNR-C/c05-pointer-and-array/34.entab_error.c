 ...
 * the online complier since it need to call the program as follows. 
 *
 * atoi.c
 * 
 ...
 * main.c:23:19: warning: implicit declaration of function ‘atoi’ [-Wimplicit-function-declaration]
 *        tabstop = atoi(*++argv);
 *                  ^~~~
 * $main
 */
