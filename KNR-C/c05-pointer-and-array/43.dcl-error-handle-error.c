 ...
 * the online c complier since it needs to call the program (in the same folder)
 * as follows
 * 
 * getch.c
 * 
 ...
 * main()
 * ^~~~
 * /tmp/ccpVYzcu.o: In function `gettoken':
 * main.c:(.text+0x284): undefined reference to `getch'
 * main.c:(.text+0x29e): undefined reference to `getch'
 * main.c:(.text+0x2d6): undefined reference to `ungetch'
 * main.c:(.text+0x308): undefined reference to `getch'
 * main.c:(.text+0x391): undefined reference to `getch'
 * main.c:(.text+0x3bd): undefined reference to `ungetch'
