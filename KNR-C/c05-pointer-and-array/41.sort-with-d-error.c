 ...
 * main(int argc, char *argv[])
 * ^~~~
 * main.c: In function ‘isdircase’:
 * main.c:161:12: warning: implicit declaration of function ‘isalnum’ [-Wimplicit-function-declaration]
 *     return isalnum(c) || c == ' ';
 *            ^~~~~~~
 * /tmp/ccCjCpBg.o: In function `main':
 * main.c:(.text+0x11f): undefined reference to `readlines'
 * main.c:(.text+0x133): undefined reference to `numcmp'
 * main.c:(.text+0x19d): undefined reference to `writelines'
 * /tmp/ccCjCpBg.o: In function `qsort':
 * main.c:(.text+0x278): undefined reference to `strtolower'
 * main.c:(.text+0x2b2): undefined reference to `strtolower'
