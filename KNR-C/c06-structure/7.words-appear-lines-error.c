 ...
 * main()
 * ^~~~
 * /tmp/ccfPAydB.o: In function `getword':
 * main.c:(.text+0x90): undefined reference to `getch'
 * main.c:(.text+0x11e): undefined reference to `getch'
 * main.c:(.text+0x160): undefined reference to `ungetch'
