 ...
 * main()
 * ^~~~
 * /tmp/ccmaDgkp.o: In function `getword':
 * main.c:(.text+0x1a7): undefined reference to `getch'
 * main.c:(.text+0x1ea): undefined reference to `getch'
 * main.c:(.text+0x204): undefined reference to `getch'
 * main.c:(.text+0x24e): undefined reference to `getch'
 * main.c:(.text+0x266): undefined reference to `getch'
 * main.c:(.text+0x2b4): undefined reference to `ungetch'
 * main.c:(.text+0x2bf): undefined reference to `getch'
 * main.c:(.text+0x2d6): undefined reference to `getch'
 * main.c:(.text+0x304): undefined reference to `getch'
 * main.c:(.text+0x37c): undefined reference to `getch'
 * main.c:(.text+0x3be): undefined reference to `ungetch'
